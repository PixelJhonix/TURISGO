        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConstitutionDocumentUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommissionPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    Guide_FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocumentNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CertificateNumber = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CertificateHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CertificateHistories_Users_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuideUnavailability", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuideUnavailability_Users_GuideId",
                        column: x => x.GuideId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Users_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_TourSchedules_TourScheduleId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Users_TouristId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateHistories_GuideId",
                table: "CertificateHistories",
                column: "GuideId");

            migrationBuilder.CreateIndex(
                name: "IX_GuideUnavailability_GuideId",
                table: "GuideUnavailability",
                column: "GuideId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TourScheduleId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_CertificateNumber",
                table: "Users",
